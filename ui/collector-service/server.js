...
app.post('/connections/run', withAuth, (req, res) => {
    args = [
        "run",
        "--rm",
        "--name", "connections-collection",
        "-e", "consumer_key=" + process.env.consumer_key,
        "-e", "consumer_secret=" + process.env.consumer_secret,
        "-e", "access_token=" + process.env.access_token,
        "-e", "access_token_secret=" + process.env.access_token_secret,
        "-e", "db_username=" + process.env.db_username,
        "-e", "db_password=" + process.env.db_password,
        "-e", "slack_url=" + process.env.slack_url,
        "-e", "RUN_TYPE=connections",
        "-e", "COLLECTION=opinion_leaders",
        "makhela/collector_2.0.32",
