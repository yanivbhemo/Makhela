...
//BlackList
export const BLACKLIST_SIZE = url + "/blacklist/getCommunitySize"
export const GET_ALL_BLACKLISTS = url + "/blacklist/getAllSuggestions"
export const GET_BLACKLISTS_BY_RANGE = url + "/blacklist/getSuggestionsByRange"
export const GET_ALL_BLACKLISTS_LIMITED = url + "/blacklist/getAllSuggestionsLimited"
